...
class TestUserAPI:
    ...
    def setup_method(self):
        ...
        self.test_user = {
            ...
            "first_name": self.existing_user["first_name"]
        }

        self.new_test_user = {
            "email": self.random_email,
            "password": "password12345",
            "first_name": "Новый Тестовый Пользователь"
        }

        self.debug = False

    def register_all_predefined_users(self):
        """Регистрация всех предопределенных пользователей из USERS_DATA"""
    ...
    def test_register_success(self):
        """Тест успешной регистрации пользователя с уникальными данными"""
    ...
    def test_register_predefined_users(self):
        """Тест регистрации всех предопределенных пользователей из data.py"""
        ...
        for user_data in USERS_DATA:
            ...
            # Store the actual user ID from the backend
            actual_id = login_data["user"]["id"]
            
            # Find which key in USER_IDS matches this user_data
    ...
    def _update_user_ids_in_data(self):
        """Update the USER_IDS in data.py with actual values from the backend"""
        global USER_IDS
        
        # Update the USER_IDS dictionary with actual values
    ...
    def test_login_success(self):
        """Тест успешной авторизации с использованием предопределенных данных"""
        for user_data in USERS_DATA:
            login_data = {
                "email": user_data["email"],
                "password": user_data["password"]
    ...
    def test_login_wrong_email(self):
        """Тест авторизации с неверным email (негативный тест)"""
        login_data = {
    ...
    def test_login_wrong_password(self):
        """Тест авторизации с неверным паролем (негативный тест)"""
        login_data = {
            "email": self.test_user["email"],
            "password": f"wrong_password_{uuid.uuid4()}"[:16]
        }
        response = self.session.post(LOGIN_URL, json=login_data)
    ...
    def test_password_too_short(self):
        """Тест регистрации со слишком коротким паролем (негативный тест)"""
        invalid_user = {
            "email": self.random_email,
            "password": "short",
    ...
    def test_invalid_email_format(self):
        """Тест регистрации с некорректным форматом email (негативный тест)"""
        invalid_user = {
            "email": "invalid_email",
    ...
    def test_update_profile(self):
        ...
        update_data = {
            "first_name": f"Обновленное Имя {uuid.uuid4()}"[:20]
        }
