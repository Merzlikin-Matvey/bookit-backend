...
class TestSeatsAPI:
    ...
    def login_as_admin(self):
        """Авторизация как админ перед каждым запросом"""
        admin_login = {
            "email": "admin@example.com",
            "password": "adminpass1234"
        }
    ...
    def login_as_user(self):
        """Авторизация как обычный пользователь перед каждым запросом"""
        user_login = {
            "email": "user1@example.com",
            "password": "userpass1234"
        }
    ...
    def test_admin_create_seat(self):
        """Тест создания места администратором"""
    ...
    def test_create_all_predefined_seats(self):
        """Создание всех предопределенных мест из data.py и сохранение их реальных ID"""
    ...
    def _update_seat_ids_in_data(self):
        """Обновляет SEAT_IDS в data.py с реальными значениями из бэкенда"""
        global SEAT_IDS
    ...
    def test_regular_user_cannot_create_seat(self):
        """Тест, что обычный пользователь не может создать место"""
    ...
    def test_get_all_seats(self):
        """Тест получения списка всех мест (доступно и администраторам, и пользователям)"""
        params = {
    ...
    def test_regular_user_cannot_update_seat(self):
        """Тест, что обычный пользователь не может обновить место"""
        admin_session = self.login_as_admin()
        seat_id = self.test_admin_create_seat()
    ...
    def test_admin_delete_seat(self):
        """Тест удаления места администратором"""
        admin_session = self.login_as_admin()
        seat_id = self.test_admin_create_seat()
    ...
    def test_regular_user_cannot_delete_seat(self):
        """Тест, что обычный пользователь не может удалить место"""
        admin_session = self.login_as_admin()
        seat_id = self.test_admin_create_seat()
    ...
    def test_invalid_seat_data(self):
        """Тест с невалидными данными для создания места"""
        admin_session = self.login_as_admin()
